...
#
# Generated by export_simulation on Sat Oct 05 17:21:22 -03 2024
#
################################################################################
...
'-reset_run' switch to the './sistema.sh' script.

./sistema.sh -reset_run
...
./sistema.sh -noclean_files

For more information on the script, please type './sistema.sh -help'.
